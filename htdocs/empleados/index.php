...
if(isset($_GET["insertar"])){
    ...
    $sqlEmpleaados = mysqli_query($conexionBD,"INSERT INTO empleados(nombre,email) VALUES('$nombre','$email') ");
    echo json_encode(["success"=>1]);
        }
    exit();
}
// Actualiza datos pero recepciona datos de nombre, email y una clave para realizar la actualización
if(isset($_GET["actualizar"])){
    ...
    $sqlEmpleaados = mysqli_query($conexionBD,"UPDATE empleados SET nombre='$nombre',email='$email' WHERE id='$id'");
    echo json_encode(["success"=>1]);
    exit();
}
